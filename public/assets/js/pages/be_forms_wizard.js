    ...
    var initWizardSimple = function() {
        jQuery(".js-wizard-simple").bootstrapWizard({
            onTabShow: function(tab, navigation, index) {
                var percent =
                    ((index + 1) / navigation.find("li").length) * 100;

                // Get progress bar
                var progress = navigation
                    .parents(".block")
                    .find('[data-wizard="progress"] > .progress-bar');
        ...
        var validatorClassic = formClassic.validate({
            ...
            messages: {
                "wizard-validation-classic-firstname": {
                    ...
                    minlength:
                        "Your firtname must consist of at least 2 characters"
                },
                "wizard-validation-classic-lastname": {
                    required: "Please enter a lastname",
                    minlength:
                        "Your lastname must consist of at least 2 characters"
                },
                "wizard-validation-classic-email":
                    "Please enter a valid email address",
                "wizard-validation-classic-bio":
                    "Let us know a few thing about yourself",
